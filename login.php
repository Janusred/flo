...
<main>
  ...
  <div class="login container">
    <form action="./login.php" method="post" class="login__left">
      ...
      <!-- INPUT PASSWORD -->
      <div>
        <label for="password" class="input-label">Contraseña <span class="text-danger">*</span></label>
        <input type="password" name="password" id="password" class="input" />
        <div class="input-help">Escribe una contraseña de por lo menos 8-10 caracteres</div>
        <!-- ERR MSG PASSWORD -->
      ...
      <!-- TOMBOL MASUK -->
      <button type="submit" name="submit" class="login__button">Inicio</button>
      <!-- LINK REGISTER CUST -->
      <p>Aun sin cuenta? <a href="./register.php">Registrar</a></p>
      <!-- LINK LOGIN STAFF -->
      <p>
        <a href="./admin/login.php">Administracion</a>
      </p>
    </form>
